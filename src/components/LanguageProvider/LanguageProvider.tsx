...
export default function LanguageProvider({
  ...
  // Initialize from the server-computed locale (based on the `partiva-locale`
  // cookie) instead of hardcoding "ar" -- otherwise every server-rendered
  // page (and any client without JS yet, e.g. first paint or a crawler)
  // always renders Arabic regardless of the visitor's saved language, only
  // "self-correcting" after the effect below reads localStorage post-hydration.
