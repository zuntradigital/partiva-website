...
export default function ForgotPasswordContent() {
  ...
  useEffect(() => {
    fetch(`${API}/api/pages`, { cache: "no-store" })
      ...
      .then((r) => { if (r?.success) setSections(resolveMainAndExtras(r.data, "forgot-password")); })
      .catch(() => {});
  }, []);
      ...
      <RevealOnScroll variant="scale" className="w-full max-w-md">
        ...
        >
          ...
          <button
            ...
            className="btn-motion flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 py-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-300 dark:disabled:bg-slate-700"
          >
            {status === "submitting" && (
